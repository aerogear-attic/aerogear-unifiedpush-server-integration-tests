...
public class BatchPushApplicationTest extends AbstractBatchTest {
    ...
    @Test
    public void batchPushApplicationRegistrationTest() {

        ups.with(BatchPushApplicationRequest.request()).register(100000);

        Long countOfAllApplications = ups.with(BatchPushApplicationRequest.request()).countOfAllApplications();

        Assert.assertThat(countOfAllApplications, CoreMatchers.is(new Long(100000)));
