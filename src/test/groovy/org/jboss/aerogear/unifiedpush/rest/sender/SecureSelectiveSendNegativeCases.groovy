...
@Mixin([AuthenticationUtils, PushApplicationUtils, AndroidVariantUtils,
    ...
    iOSVariantUtils])
class SecureSelectiveSendNegativeCases extends Specification {
    ...
    def static WebArchive "create deployment"() {
        Deployments.customUnifiedPushServerWithClasses(SecureSelectiveSendNegativeCases.class, Constants.class)
    }
