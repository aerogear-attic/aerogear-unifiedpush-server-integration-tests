...
class SelectiveSendByCommonAlias extends Specification {
    ...
    def private final static COMMON_IOS_ANDROID_SIMPLE_PUSH_CLIENT_ALIAS = "qa_ios_android_simplepush@aerogear"
    ...
    def static WebArchive "create deployment"() {
        Deployments.customUnifiedPushServerWithClasses(SelectiveSendByCommonAlias.class, Constants.class, ServerSocketUtils.class)
    }
    ...
    def "Register a third installation for an Android device"() {
        ...
        def androidInstallation = createInstallation(ANDROID_DEVICE_TOKEN_3, ANDROID_DEVICE_TYPE,
                ANDROID_DEVICE_OS, ANDROID_DEVICE_OS_VERSION, COMMON_IOS_ANDROID_SIMPLE_PUSH_CLIENT_ALIAS, null, null)
    ...
    def "Register an installation for a Simple Push device"() {
        ...
        def simplePushInstallation = createInstallation(SIMPLE_PUSH_DEVICE_TOKEN, SIMPLE_PUSH_DEVICE_TYPE,
                SIMPLE_PUSH_DEVICE_OS, "", COMMON_IOS_ANDROID_SIMPLE_PUSH_CLIENT_ALIAS, SIMPLE_PUSH_CATEGORY, SIMPLE_PUSH_VARIANT_NETWORK_URL)
    ...
    def "Verify that right GCM & APN notifications were sent - Target multiple devices by alias case"() {
        ...
        ApnsServiceImpl.getTokensList.contains(IOS_DEVICE_TOKEN_2)
