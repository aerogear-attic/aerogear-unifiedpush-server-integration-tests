...
@Mixin([AuthenticationUtils, PushApplicationUtils, AndroidVariantUtils,
    ...
    iOSVariantUtils])
class SecureIosSelectiveSendFilteredByOsSpecification extends Specification {
    ...
    def static WebArchive "create deployment"() {
        Deployments.customUnifiedPushServerWithClasses(SecureIosSelectiveSendFilteredByOsSpecification.class, Constants.class)
    }
