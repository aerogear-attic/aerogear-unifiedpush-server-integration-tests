...
@Mixin([AuthenticationUtils, PushApplicationUtils, AndroidVariantUtils,
    ...
    iOSVariantUtils])
class SecureIosSelectiveSendFilteredByAliasSpecification extends Specification {
    ...
    def static WebArchive "create deployment"() {
        Deployments.customUnifiedPushServerWithClasses(SecureIosSelectiveSendFilteredByAliasSpecification.class, Constants.class)
    }
