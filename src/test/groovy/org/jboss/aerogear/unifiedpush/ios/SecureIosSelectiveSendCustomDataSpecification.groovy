...
@Mixin([AuthenticationUtils, PushApplicationUtils, AndroidVariantUtils,
    ...
    iOSVariantUtils])
class SecureIosSelectiveSendCustomDataSpecification extends Specification {
    ...
    def private final static CUSTOM_FIELD_DATA_KEY = "custom"

    def private final static CUSTOM_FIELD_DATA_MSG = "This is custom data"
    ...
    def static WebArchive "create deployment"() {
        Deployments.customUnifiedPushServerWithClasses(IosSelectiveSendFilteredByAliasSpecification.class, Constants.class)
    }
