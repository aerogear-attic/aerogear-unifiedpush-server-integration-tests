...
class SecureSimplePushSelectiveSendByOsSpecification extends Specification {
    ...
    def static WebArchive "create deployment"() {
        Deployments.customUnifiedPushServerWithClasses(SecureSimplePushSelectiveSendByOsSpecification.class, Constants.class)
    }
