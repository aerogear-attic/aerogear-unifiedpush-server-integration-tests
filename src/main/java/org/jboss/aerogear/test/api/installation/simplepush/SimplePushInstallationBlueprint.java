...
public class SimplePushInstallationBlueprint extends InstallationBlueprint<SimplePushInstallationBlueprint,
        SimplePushInstallationEditor, SimplePushVariant, SimplePushInstallationWorker, SimplePushInstallationContext> {

    public SimplePushInstallationBlueprint(SimplePushInstallationContext context) {
        super(context);
    }
