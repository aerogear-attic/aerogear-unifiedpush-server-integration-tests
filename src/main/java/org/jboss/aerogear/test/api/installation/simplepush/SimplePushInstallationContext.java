...
public class SimplePushInstallationContext extends InstallationContext<SimplePushInstallationBlueprint,
    ...
    public SimplePushInstallationContext(SimplePushInstallationWorker worker, SimplePushVariant parent, Session session) {
        super(worker, parent, session);
    }

    @Override
    protected SimplePushInstallationContext castInstance() {
        return this;
    }

    @Override
    protected SimplePushInstallationEditor createEditor() {
