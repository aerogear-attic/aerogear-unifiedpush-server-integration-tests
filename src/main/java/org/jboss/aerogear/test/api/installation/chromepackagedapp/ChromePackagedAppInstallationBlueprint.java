...
public class ChromePackagedAppInstallationBlueprint extends
        ...
        ChromePackagedAppVariant, ChromePackagedAppInstallationWorker, ChromePackagedAppInstallationContext> {

    public ChromePackagedAppInstallationBlueprint(ChromePackagedAppInstallationContext context) {
        super(context);
    }

    public ChromePackagedAppInstallationContext persist() {
