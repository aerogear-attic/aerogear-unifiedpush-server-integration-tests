...
public class ChromePackagedAppInstallationContext extends InstallationContext<ChromePackagedAppInstallationBlueprint,
    ...
    public ChromePackagedAppInstallationContext(ChromePackagedAppInstallationWorker worker,
                                                ChromePackagedAppVariant parent, Session session) {
        super(worker, parent, session);
    }

    @Override
    protected ChromePackagedAppInstallationContext castInstance() {
        return this;
    }

    @Override
    protected ChromePackagedAppInstallationEditor createEditor() {
